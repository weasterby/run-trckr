...
INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (1, 64124462, 'Activity 1', '', 5000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-24T08:00:00Z', '2020-08-24T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (64124462, 1, 1, 1) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (2, 64124462, 'Activity 2', '', 8000, 1950, 2000, 100, 100, 0, 'Running', '2020-08-25T08:00:00Z', '2020-08-25T08:00:00Z',
        'CST', 1, 4.1265, 4.1265) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (64124462, 1, 1, 2) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (3, 64124462, 'Activity 3', '', 10000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-26T08:00:00Z', '2020-08-26T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (64124462, 1, 1, 3) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (4, 1, 'Activity 4', '', 5000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-24T08:00:00Z', '2020-08-24T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (1, 1, 1, 4) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (5, 1, 'Activity 5', '', 8000, 1950, 2000, 100, 100, 0, 'Running', '2020-08-25T08:00:00Z', '2020-08-25T08:00:00Z',
        'CST', 1, 4.1265, 4.1265) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (1, 1, 1, 5) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (6, 1, 'Activity 6', '', 10000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-26T08:00:00Z', '2020-08-26T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (1, 1, 1, 6) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (7, 2, 'Activity 7', '', 5000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-24T08:00:00Z', '2020-08-24T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (2, 1, 1, 7) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (8, 2, 'Activity 8', '', 8000, 1950, 2000, 100, 100, 0, 'Running', '2020-08-25T08:00:00Z', '2020-08-25T08:00:00Z',
        'CST', 1, 4.1265, 4.1265) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (2, 1, 1, 8) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (9, 2, 'Activity 9', '', 10000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-26T08:00:00Z', '2020-08-26T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (2, 1, 1, 9) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (10, 3, 'Activity 10', '', 5000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-24T08:00:00Z', '2020-08-24T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (3, 1, 1, 10) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (11, 3, 'Activity 11', '', 8000, 1950, 2000, 100, 100, 0, 'Running', '2020-08-25T08:00:00Z', '2020-08-25T08:00:00Z',
        'CST', 1, 4.1265, 4.1265) ON CONFLICT DO NOTHING;
INSERT INTO contest_activities("user", "group", contest, activity) VALUES (3, 1, 1, 11) ON CONFLICT DO NOTHING;

INSERT INTO activities(id, "user", name, description, distance, moving_time, elapsed_time,total_elevation_gain, elev_high,
                       elev_low, type, start_date, start_date_local, timezone, workout_type, average_speed, max_speed)
VALUES (12, 3, 'Activity 12', '', 10000, 1200, 1500, 100, 100, 0, 'Running', '2020-08-26T08:00:00Z', '2020-08-26T08:00:00Z',
        'CST', 1, 4.1693, 4.1693) ON CONFLICT DO NOTHING;
